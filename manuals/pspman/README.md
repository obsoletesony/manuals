...
- `source/` contains PSPMAN-specific layout, style, vector-diagram, build, and validation code. It imports only byte-stable mechanics from the repository-level `manualkit` package.
